...
initial_height = 3.0
gt = lm.epanet_groundtruth(initial_height)[0]
...
for i in range(10, 50):
    for j in range(5, 50):
        ...
        mt_disc = lm.disc_tank_height(round_disc_demand, n_tank_states, initial_height)
        disc_y = mt_disc[1]
        r = lm.calc_rmse(disc_y, gt)
        n = i*j
